                        ...
                        if is_visible and is_revealed then
                            ...
                            if is_render_vehicle_icon then
                                ...
                                if vehicle_definition_index ~= e_game_object_type.chassis_carrier then
                                    local vehicle_id_str = tostring(vehicle:get_id())
                                    local prefix = ""
                                    
                                    -- Add prefix based on vehicle type
                                    ...
                                    -- Prepend prefix to vehicle ID if one exists
                                    if prefix ~= "" then
                                        vehicle_id_str = prefix .. "-" .. vehicle_id_str
                                    end

                                    update_ui_text(screen_pos_x - 3, screen_pos_y - 14, vehicle_id_str, 128, 0, element_color, 0)
                                end
                                -- End modified lines
