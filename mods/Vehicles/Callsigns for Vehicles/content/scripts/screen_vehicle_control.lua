...
function get_is_selection()
    if g_selection_vehicle_id > 0 or g_selection_waypoint_id > 0 or g_selection_attack_target_vehicle_id > 0 or g_is_selection_map then
        return true;
    else
        return false;
    end
...
function render_selection_vehicle(screen_w, screen_h, vehicle)
    ...
    if screen_vehicle:get() then
        if screen_vehicle:get_team() == vehicle:get_team() then
            ...
            ui:begin_window(update_get_loc(e_loc.upp_status), 10, 10, left_w, 100, atlas_icons.column_pending, true, 2)
                    ...
                    if is_visible and is_revealed then
                        ...
                        if is_render_vehicle_icon then
                            ...
                            if vehicle_definition_index ~= e_game_object_type.chassis_carrier then
                                ...
                                update_ui_text(screen_pos_x, screen_pos_y - 13, vehicle_id_str, 2, 1, element_color, 0)
                            end
