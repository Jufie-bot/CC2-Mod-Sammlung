...
function render_ground_hud(screen_w, screen_h, vehicle)
    ...
    render_compass(vec2(hud_pos:x(), hud_min:y() + hud_size:y()), col, vehicle)
...
function render_compass(pos, col, screen_vehicle)
    local width = 120
